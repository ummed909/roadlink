import classes from "./SignInC.module.css";
    ...
    <div className={classes.container}>
      <div className={classes.container1}>
        ...
        <form className={classes.form}>
          ...
          <div className={classes.link}><NavLink to='/ragistrationC/signUpC' className={classes.navlink}>Not register yest? SignUp</NavLink></div>
        </form>
      </div>
    </div>
  );
